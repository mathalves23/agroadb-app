...
class TestCARScraperSearch:
    ...
    async def test_search_by_cpf_cnpj(self, car_scraper):
        ...
        with patch.object(
            car_scraper, "_search_by_cpf_cnpj", new_callable=AsyncMock
        ) as mock_search:
    ...
    async def test_search_by_name_fallback(self, car_scraper):
        ...
        with (
            patch.object(car_scraper, "_search_by_cpf_cnpj", new_callable=AsyncMock) as mock_cpf,
            ...
            results = await car_scraper.search(name="João Silva", cpf_cnpj="12345678000190")
...
class TestCARScraperParseData:
    ...
    def test_parse_car_data_complete(
        ...
        result = car_scraper._parse_car_data(
            mock_car_demonstrativo_data, mock_car_imovel_data, car_number
        )
