...
def test_bigquery_config_creation():
    ...
    config = DataWarehouseConfig(
        warehouse_type=DataWarehouseType.BIGQUERY, project_id="test-project", dataset="test_dataset"
    )
...
def test_bigquery_exporter_creation():
    ...
    config = DataWarehouseConfig(
        warehouse_type=DataWarehouseType.BIGQUERY, project_id="test", dataset="test"
    )
...
def test_redshift_exporter_creation():
    ...
    from app.analytics.data_export import DataWarehouseConfig, DataWarehouseType, RedshiftExporter

    config = DataWarehouseConfig(
        warehouse_type=DataWarehouseType.REDSHIFT, cluster="test", database="test", schema="public"
    )
...
def test_redshift_ddl_generation(sample_data):
    ...
    config = DataWarehouseConfig(
        warehouse_type=DataWarehouseType.REDSHIFT, cluster="test", database="test"
    )
...
def test_file_exporter_csv(sample_data):
    ...
    from app.analytics.data_export import ExportConfig, ExportFormat, FileExporter
...
def test_export_job_creation():
    ...
    from app.analytics.data_export import ExportFormat, ExportJob, ExportStatus
...
def test_integration_workflow():
    ...
    from app.analytics.data_export import DataExportManager, ExportFormat, ExportStatus
