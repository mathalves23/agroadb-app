...
async def test_enqueue_investigation_priority_adjustment(clean_redis):
    ...
    task_ids = await enqueue_investigation_scrapers(
        investigation_id="inv_test", target_name="Test", priority=TaskPriority.NORMAL
    )
...
async def test_cancel_investigation_scrapers(clean_redis):
    ...
    # Enfileirar scrapers
    task_ids = await enqueue_investigation_scrapers(
        investigation_id="inv_cancel", target_name="Test"
    )
...
async def test_cancel_only_pending_tasks(clean_redis):
    ...
    task_ids = await enqueue_investigation_scrapers(
        investigation_id="inv_cancel_partial", target_name="Test"
    )
...
async def test_full_worker_flow(clean_redis):
    ...
    # Enfileirar
    task_ids = await enqueue_investigation_scrapers(investigation_id="inv_flow", target_name="Test")
