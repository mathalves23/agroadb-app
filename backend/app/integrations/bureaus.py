...
class BureauIntegration:
    ...
    async def query_serasa(self, cpf_cnpj: str, product: str = "basic") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            data = {"documento": cpf_cnpj, "produto": product}
    ...
    async def query_boavista(self, cpf_cnpj: str) -> Dict[str, Any]:
        """
    ...
    async def query_all_bureaus(self, cpf_cnpj: str) -> Dict[str, Any]:
        """Consulta todos os bureaus disponíveis"""
        import asyncio

        tasks = [self.query_serasa(cpf_cnpj), self.query_boavista(cpf_cnpj)]
...
async def check_credit(
    cpf_cnpj: str, serasa_key: Optional[str] = None, boavista_key: Optional[str] = None
) -> Dict[str, Any]:
