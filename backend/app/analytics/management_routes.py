...
async def get_executive_management_report(
    ...
    **Requer: admin ou executive**
    ...
    from app.analytics.management_reports import CostReport, ROIReport
    ...
    executive_report["reports"]["roi"] = consolidator.roi_report.generate_report(
        start_date, end_date
    )
    executive_report["reports"]["costs"] = consolidator.cost_report.generate_report(
        start_date, end_date
    )
...
async def management_reports_health():
    ...
    return {
        ...
        "reports_available": ["roi", "costs", "performance", "uptime", "errors", "executive"],
    }
