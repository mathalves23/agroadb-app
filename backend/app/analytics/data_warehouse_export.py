...
class DataWarehouseExporter:
    ...
    async def export_to_redshift(
        self, schema: str, table: str, data_type: str = "investigations"
    ) -> Dict[str, Any]:
        """
    ...
    async def create_tableau_extract(
        self, extract_name: str, data_type: str = "investigations"
    ) -> Dict[str, Any]:
        """
    ...
    async def create_powerbi_dataset(
        self, workspace_id: str, dataset_name: str, data_type: str = "investigations"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            result = {
                ...
                "data_type": data_type,
                "schema": schema,
                "refresh_schedule": {"enabled": True, "frequency": "daily", "time": "03:00"},
            ...
            if endpoint == "metrics":
                ...
                data = {
                    ...
                    "by_status": {
                        ...
                        "in_progress": len(
                            [i for i in investigations if i.status == "in_progress"]
                        ),
        ...
        try:
            ...
            history = [
                {
                    ...
                    "completed_at": (
                        datetime.utcnow() - timedelta(hours=i) + timedelta(minutes=5)
                    ).isoformat(),
            ...
            return {
                ...
                "summary": {
                    ...
                    "success_rate": (
                        round(
                            len([h for h in history if h["status"] == "success"])
                            / len(history)
                            * 100,
                            2,
                        )
