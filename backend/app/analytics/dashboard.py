        ...
        widgets.append(
            DashboardWidget(
                ...
                data={
                    "chart_type": "line",
                    "series": [
                        {"name": "Investigações", "data": summary["usage"]["daily_activity"]}
                    ],
                },
                metadata={"height": 300},
            )
            ...
            DashboardWidget(
                ...
                data={
                    ...
                    "series": [
                        ...
                        for status, count in summary["overview"]["investigations"][
                            "by_status"
                        ].items()
                    ],
                },
        ...
        widgets.append(
            DashboardWidget(
                ...
                data={
                    ...
                    "rows": [
                        [user["username"], user["email"], user["investigation_count"]]
        ...
        widgets.append(
            DashboardWidget(
                ...
                data={
                    "chart_type": "bar",
                    "series": [
                        {"name": item["state"], "value": item["properties_count"]}
        ...
        widgets.append(
            DashboardWidget(
                ...
                data={
                    "chart_type": "line",
                    "series": [
                        {"name": "Investigações", "data": report["usage"]["daily_activity"]}
                    ],
                },
            )
        )
...
class ReportGenerator:
    ...
    def export_to_excel_format(self, data: Dict) -> Dict[str, Any]:
        ...
        if "summary" in data or "executive_summary" in data:
            ...
            sheets.append({"sheet_name": "Sumário", "data": self._flatten_dict(summary)})
        ...
        if "kpis" in data.get("summary", {}) or "kpis" in data.get("executive_summary", {}):
            ...
            sheets.append(
                {
                    "sheet_name": "KPIs",
                    "data": [{"Métrica": key, "Valor": value} for key, value in kpis.items()],
                }
            )
