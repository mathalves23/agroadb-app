...
class INCRAScraper(BaseScraper):
    ...
    async def _search_by_cpf_cnpj(
        self, cpf_cnpj: str, state: Optional[str] = None, city: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def verify_ccir_authenticity(self, ccir_number: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.fetch(verify_url, params={"ccir": ccir_formatted})
    ...
    def _parse_ccir_data(self, data: Dict[str, Any], ccir_number: str) -> Dict[str, Any]:
        """
    ...
    def _parse_property_data(self, data: Dict[str, Any], property_code: str) -> Dict[str, Any]:
        """
