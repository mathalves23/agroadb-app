...
class CARScraper(BaseScraper):
    ...
    async def _search_by_cpf_cnpj(
        self, cpf_cnpj: str, state: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    def _parse_car_data(
        self, demonstrativo: Dict[str, Any], imovel: Dict[str, Any], car_number: str
    ) -> Dict[str, Any]:
        """
                ...
                if isinstance(geometry, dict):
                    if geometry.get("type") == "Polygon":
                        ...
                        coordinates["polygon"] = {
                            "type": "Polygon",
                            "coordinates": (
                                geometry["coordinates"][0] if geometry.get("coordinates") else []
                            ),
                        }
    ...
    async def search_by_municipality(
        self, state: str, city: str, limit: int = 100
    ) -> List[Dict[str, Any]]:
        """
