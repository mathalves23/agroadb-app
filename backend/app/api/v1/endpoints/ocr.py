...
@router.post("/process", response_model=OCRResponse, summary="Processa documento com OCR")
...
@router.post(
    "/extract-entities", response_model=EntityExtractionResponse, summary="Extrai CPF/CNPJ de texto"
)
async def extract_entities_from_text(text: str, current_user: User = Depends(get_current_user)):
    """
    ...
    try:
        ...
        return EntityExtractionResponse(
            cpf=entities.get("cpf", []), cnpj=entities.get("cnpj", []), total_found=total
        )
...
@router.post("/extract-from-image", summary="Extrai texto de imagem")
...
@router.get("/health", summary="Verifica disponibilidade do OCR")
