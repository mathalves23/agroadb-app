...
from app.core.two_factor import TwoFactorAuth, TwoFactorService
...
async def get_2fa_status(
    ...
    result = await db.execute(select(TwoFactorAuth).where(TwoFactorAuth.user_id == current_user.id))
