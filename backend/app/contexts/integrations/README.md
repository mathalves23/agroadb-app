...
- Rotas HTTP: `app/api/v1/endpoints/integrations/` (pacote com sub-routers + `remainder.py`).
...
1. Partir `remainder.py` em mais sub-routers: dados abertos, transparência, fiscalização, notificações HTTP, etc.
