...
class PortalTransparenciaService:
    ...
    async def _cached_get(
        self, method: str, doc: str, path: str, params: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    @circuit_protected(
        service_name="portal_transparencia", failure_threshold=5, recovery_timeout=60.0
    )
    async def consultar_ceis(self, cnpj_cpf: str) -> Dict[str, Any]:
        """Cadastro de Empresas Inidôneas e Suspensas (sanções)"""
        return await self._cached_get(
            "ceis", cnpj_cpf, "/ceis", params={"cnpjSancionado": cnpj_cpf}
        )
    ...
    async def consultar_cnep(self, cnpj_cpf: str) -> Dict[str, Any]:
        ...
        return await self._cached_get(
            "cnep", cnpj_cpf, "/cnep", params={"cnpjSancionado": cnpj_cpf}
        )
    ...
    async def consultar_acordos_leniencia(self, cnpj: str) -> Dict[str, Any]:
        ...
        return await self._cached_get(
            "acordos_leniencia", cnpj, "/acordos-leniencia", params={"cnpjSancionado": cnpj}
        )
    ...
    async def consultar_contratos(self, cpf_cnpj: str) -> Dict[str, Any]:
        ...
        return await self._cached_get(
            "contratos", cpf_cnpj, "/contratos", params={"cpfCnpjContratado": cpf_cnpj}
        )
    ...
    async def consultar_gastos_cartao(self, cpf_cnpj: str) -> Dict[str, Any]:
        ...
        return await self._cached_get(
            "gastos_cartao", cpf_cnpj, "/cartoes", params={"cpfCnpjFavorecido": cpf_cnpj}
        )
    ...
    async def consultar_beneficios(self, cpf: str) -> Dict[str, Any]:
        ...
        return await self._cached_get(
            "beneficios", cpf, "/beneficios-cidadao", params={"cpfBeneficiario": cpf}
        )
