...
class BoaVistaService:
    ...
    async def _authenticate(self):
        ...
        if not self.client_id or not self.client_secret:
            ...
            logger.info("Configure BOAVISTA_CLIENT_ID e BOAVISTA_CLIENT_SECRET no .env")
            return
    ...
    async def consultar_score(self, cpf_cnpj: str) -> Optional[BoaVistaScore]:
        """
        ...
        try:
            ...
            payload = {"documento": doc_clean, "tipoPessoa": "F" if len(doc_clean) == 11 else "J"}
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    logger.info(f"✅ Boa Vista Score: {score.score} ({score.classificacao})")
    ...
    async def consultar_restricoes(self, cpf_cnpj: str) -> List[BoaVistaRestricao]:
        """
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    logger.info(f"✅ Boa Vista: {len(restricoes)} restrições encontradas")
    ...
    async def consultar_consultas_recentes(self, cpf_cnpj: str) -> int:
        """
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    logger.info(f"✅ Boa Vista: {quantidade} consultas recentes")
