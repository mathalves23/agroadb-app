...
class ReportGenerator:
    ...
    def _create_pdf_header(self, investigation: Dict[str, Any], styles) -> List:
        ...
        # Título
        title = Paragraph(f"<b>RELATÓRIO DE INVESTIGAÇÃO PATRIMONIAL</b>", styles["Title"])
    ...
    def _create_pdf_executive_summary(
        self, investigation: Dict[str, Any], results: Dict[str, Any], styles
    ) -> List:
    ...
    def _create_pdf_detailed_sections(self, results: Dict[str, Any], styles) -> List:
        ...
        if results.get("car") or results.get("incra"):
            ...
            if results.get("car"):
                elements.append(
                    Paragraph("<b>2.1 Cadastro Ambiental Rural (CAR)</b>", styles["Heading2"])
                )
    ...
    def generate_excel_report(
        self, investigation: Dict[str, Any], results: Dict[str, Any]
    ) -> BytesIO:
        """
    ...
    def _create_excel_summary_sheet(
        self, wb: openpyxl.Workbook, investigation: Dict[str, Any], results: Dict[str, Any]
    ):
