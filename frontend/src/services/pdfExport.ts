...
export class PDFExportService {
  private static readonly PRIMARY_COLOR: RgbTuple = [99, 102, 241]
  private static readonly TEXT_COLOR: RgbTuple = [17, 24, 39]
  ...
  private static addPropertiesTable(doc: jsPDF, y: number, properties: Property[]): number {
    ...
    autoTable(doc, {
      ...
      theme: 'striped',
      headStyles: {
        fillColor: [...this.PRIMARY_COLOR] as [number, number, number],
